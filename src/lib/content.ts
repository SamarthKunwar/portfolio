...
const en: Dict = {
  ...
  about: {
    heading: "About",
    paragraphs: [
      "I'm a Computer Science student in my fifth semester at Hochschule Kaiserslautern, and I'm happiest building something end to end: the database, the backend, the interface, and the moment it goes live. Two things pull at me about equally, full-stack applications and AI tools, and my favourite projects are the ones where both show up.",
...
const de: Dict = {
  ...
  about: {
    heading: "Über mich",
    paragraphs: [
      "Ich studiere Informatik im fünften Semester an der Hochschule Kaiserslautern, und am glücklichsten bin ich, wenn ich etwas von Anfang bis Ende baue: Datenbank, Backend, Oberfläche und den Moment, in dem es online geht. Zwei Dinge reizen mich ungefähr gleich stark, Full-Stack-Anwendungen und KI-Tools, und meine liebsten Projekte sind die, in denen beides vorkommt.",
