  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative flex h-full flex-col overflow-hidden rounded-xl border border-[var(--color-border)] bg-[var(--color-bg)] transition-[border-color,box-shadow] duration-300 hover:border-[var(--color-primary)] hover:shadow-[0_18px_50px_-16px_rgba(58,38,20,0.20)]"
      >
          ...
          <div className="mt-5 flex flex-wrap items-center gap-x-5 gap-y-2 text-sm font-medium">
            ...
            {project.demo ? (
              <a
                ...
                className="relative z-10 inline-flex items-center gap-1 text-[var(--color-muted)] underline decoration-[var(--color-border)] underline-offset-4 transition-colors hover:text-[var(--color-fg)] hover:decoration-[var(--color-fg)]"
              >
                {liveDemo}
